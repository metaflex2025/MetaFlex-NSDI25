...
int main()
{
    ...
    auto reg_r = description.find_register("MM_ENQ_MAX");
    if (! reg_r)
    {
        ::perror("Could not find register in core descriptions");
        return EXIT_FAILURE;
    ...
    // Start Sifter
    reg_r = description.find_register("MM_START");
    if (! reg_r)
    {
        ::perror("Could not find register in core descriptions");
        return EXIT_FAILURE;
    ...
    // Read counts
    reg_r = description.find_register("MM_ENQ_COUNT");
    if (! reg_r)
    {
        ::perror("Could not find register in core descriptions");
        return EXIT_FAILURE;
    ...
    reg_r = description.find_register("MM_DEQ_COUNT");
    if (! reg_r)
    {
        ::perror("Could not find register in core descriptions");
        return EXIT_FAILURE;
    ...
    reg_r = description.find_register("MM_OVFL_COUNT");
    if (! reg_r)
    {
        ::perror("Could not find register in core descriptions");
        return EXIT_FAILURE;
